...
export const getAppPinStatus = api.getAppPinStatus;
export const setAppPin = api.setAppPin;
export const verifyAppPin = api.verifyAppPin;
export const disableAppPin = api.disableAppPin;
...
export const createDevicePairing = api.createDevicePairing;
export const getDevicePairing = api.getDevicePairing;
export const cancelDevicePairing = api.cancelDevicePairing;
export const getLinkedDevices = api.getLinkedDevices;
export const updateLinkedDevice = api.updateLinkedDevice;
export const revokeLinkedDevice = api.revokeLinkedDevice;
export const getDeviceMessages = api.getDeviceMessages;
export const createDeviceMessage = api.createDeviceMessage;
export const revokeDeviceMessage = api.revokeDeviceMessage;
...
export const getContinuityPanel = api.getContinuityPanel;
export const getHealthSheet = api.getHealthSheet;
export const getHealthProblems = api.getHealthProblems;
export const createHealthProblem = api.createHealthProblem;
export const updateHealthProblem = api.updateHealthProblem;
export const getHealthVaccines = api.getHealthVaccines;
export const createHealthVaccine = api.createHealthVaccine;
export const updateHealthVaccine = api.updateHealthVaccine;
export const getHealthExamResults = api.getHealthExamResults;
export const createHealthExamResult = api.createHealthExamResult;
export const updateHealthExamResult = api.updateHealthExamResult;
export const createHealthSheetAction = api.createHealthSheetAction;
